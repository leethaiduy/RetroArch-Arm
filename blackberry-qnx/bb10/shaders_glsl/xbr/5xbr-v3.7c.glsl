...
void main()
{
    ...
    _r0145.x = float(_TMP66);
    _TMP66 = dot(vec3(float(_E.x), float(_E.y), float(_E.z)), vec3( 1.43593750E+01, 2.81718750E+01, 5.47265625E+00));
    _r0145.y = float(_TMP66);
    _TMP66 = dot(vec3(float(_E.x), float(_E.y), float(_E.z)), vec3( 1.43593750E+01, 2.81718750E+01, 5.47265625E+00));
    _r0145.z = float(_TMP66);
    _TMP66 = dot(vec3(float(_E.x), float(_E.y), float(_E.z)), vec3( 1.43593750E+01, 2.81718750E+01, 5.47265625E+00));
    _r0145.w = float(_TMP66);
    ...
    _TMP66 = dot(vec3(float(_TMP46.x), float(_TMP46.y), float(_TMP46.z)), vec3( 1.43593750E+01, 2.81718750E+01, 5.47265625E+00));
    _r0319.x = float(_TMP66);
    _TMP66 = dot(vec3(float(_TMP52.x), float(_TMP52.y), float(_TMP52.z)), vec3( 1.43593750E+01, 2.81718750E+01, 5.47265625E+00));
    _r0319.y = float(_TMP66);
    _a0325 = vec2(float(_r0319.x), float(_r0319.y)) - _e1.xy;
    _df12 = abs(_a0325);
    _TMP59 = float((_df12.y >= _df12.x));
    _t0329 = float(_TMP59);
    _res = _TMP46 + _t0329*(_TMP52 - _TMP46);
