...
void main()
{
    ...
    _r0151.x = float(_TMP72);
    _TMP72 = dot(vec3(float(_E.x), float(_E.y), float(_E.z)), vec3( 1.43593750E+01, 2.81718750E+01, 5.47265625E+00));
    _r0151.y = float(_TMP72);
    _TMP72 = dot(vec3(float(_E.x), float(_E.y), float(_E.z)), vec3( 1.43593750E+01, 2.81718750E+01, 5.47265625E+00));
    _r0151.z = float(_TMP72);
    _TMP72 = dot(vec3(float(_E.x), float(_E.y), float(_E.z)), vec3( 1.43593750E+01, 2.81718750E+01, 5.47265625E+00));
    _r0151.w = float(_TMP72);
    ...
    _a0237 = _b1.zwxy - _h5;
    _TMP234 = abs(_a0237);
    _TMP34 = bvec4(_TMP234.x < 1.50000000E+01, _TMP234.y < 1.50000000E+01, _TMP234.z < 1.50000000E+01, _TMP234.w < 1.50000000E+01);
    _a0243 = _b1.zwxy - _i5;
    _TMP240 = abs(_a0243);
    _TMP35 = bvec4(_TMP240.x < 1.50000000E+01, _TMP240.y < 1.50000000E+01, _TMP240.z < 1.50000000E+01, _TMP240.w < 1.50000000E+01);
    _a0249 = _e1 - _c3.zwxy;
    _TMP246 = abs(_a0249);
    _TMP36 = bvec4(_TMP246.x < 1.50000000E+01, _TMP246.y < 1.50000000E+01, _TMP246.z < 1.50000000E+01, _TMP246.w < 1.50000000E+01);
    _a0255 = _e1 - _c3;
    _TMP252 = abs(_a0255);
    _TMP37 = bvec4(_TMP252.x < 1.50000000E+01, _TMP252.y < 1.50000000E+01, _TMP252.z < 1.50000000E+01, _TMP252.w < 1.50000000E+01);
    ...
    _a0269 = _c3.wxyz - _h5;
    _TMP266 = abs(_a0269);
    _a0273 = _c3.wxyz - _h5.yzwx;
    _TMP270 = abs(_a0273);
    _a0277 = _b1.zwxy - _b1.wxyz;
    _TMP274 = abs(_a0277);
    _TMP38 = _TMP258 + _TMP262 + _TMP266 + _TMP270 + 4.00000000E+00*_TMP274;
    _a0283 = _b1.zwxy - _b1.yzwx;
    _TMP280 = abs(_a0283);
    _a0287 = _b1.zwxy - _i5;
    _TMP284 = abs(_a0287);
    _a0291 = _b1.wxyz - _i4;
    ...
    _a0299 = _e1 - _c3.wxyz;
    _TMP296 = abs(_a0299);
    _TMP39 = _TMP280 + _TMP284 + _TMP288 + _TMP292 + 4.00000000E+00*_TMP296;
    ...
    _a0303 = _b1.wxyz - _c3.zwxy;
    _TMP300 = abs(_a0303);
    _a0307 = _b1.zwxy - _c3;
    _TMP304 = abs(_a0307);
    _edr_left = bvec4((2.00000000E+00*_TMP300).x <= _TMP304.x && _interp_restriction_lv2_left.x, (2.00000000E+00*_TMP300).y <= _TMP304.y && _interp_restriction_lv2_left.y, (2.00000000E+00*_TMP300).z <= _TMP304.z && _interp_restriction_lv2_left.z, (2.00000000E+00*_TMP300).w <= _TMP304.w && _interp_restriction_lv2_left.w);
    _a0311 = _b1.wxyz - _c3.zwxy;
    _TMP308 = abs(_a0311);
    _a0315 = _b1.zwxy - _c3;
    _TMP312 = abs(_a0315);
    _edr_up = bvec4(_TMP308.x >= (2.00000000E+00*_TMP312).x && _interp_restriction_lv2_up.x, _TMP308.y >= (2.00000000E+00*_TMP312).y && _interp_restriction_lv2_up.y, _TMP308.z >= (2.00000000E+00*_TMP312).z && _interp_restriction_lv2_up.z, _TMP308.w >= (2.00000000E+00*_TMP312).w && _interp_restriction_lv2_up.w);
    _a0319 = _e1 - _b1.wxyz;
    _TMP316 = abs(_a0319);
    _a0323 = _e1 - _b1.zwxy;
    _TMP320 = abs(_a0323);
    _px = bvec4(_TMP316.x <= _TMP320.x, _TMP316.y <= _TMP320.y, _TMP316.z <= _TMP320.z, _TMP316.w <= _TMP320.w);
    _t0325 = vec4(float(_px.x), float(_px.y), float(_px.z), float(_px.w));
    _TMP46 = _b1.zwxy + _t0325*(_b1.wxyz - _b1.zwxy);
    _dilation = bvec4(_TMP46.x > _e1.x, _TMP46.y > _e1.y, _TMP46.z > _e1.z, _TMP46.w > _e1.w);
    ...
    _a0329 = _E - _TMP47;
    _TMP73 = abs(vec3(float(_a0329.x), float(_a0329.y), float(_a0329.z)));
    _df0327 = vec3(float(_TMP73.x), float(_TMP73.y), float(_TMP73.z));
    _TMP63 = _df0327.x + _df0327.y + _df0327.z;
    _a0333 = _E - _TMP55;
    _TMP73 = abs(vec3(float(_a0333.x), float(_a0333.y), float(_a0333.z)));
    _df0331 = vec3(float(_TMP73.x), float(_TMP73.y), float(_TMP73.z));
    _TMP64 = _df0331.x + _df0331.y + _df0331.z;
    _TMP65 = float((_TMP64 >= _TMP63));
    _res = _TMP47 + _TMP65*(_TMP55 - _TMP47);
